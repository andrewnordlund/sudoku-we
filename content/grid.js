...
propagate_naked_pairs: function() {
	...
	for (r = 0;r<9;r++) {
		for (c = 0;c<9;c++) {
			if (2==this.count_possibilities(r, c)) {
				for (sub = r+1; sub<9; sub++) {
					if (2==this.count_possibilities(sub, c) && this.compare_possibilities(r, c, sub, c)) {
						for (i = 0;i<9;i++) {
							if (i!=r && i!=sub) {
								for (j = 1;j<10;j++) {
				...
				for (sub = c+1; sub<9; sub++) {
					if (2==this.count_possibilities(r, sub) && this.compare_possibilities(r, c, r, sub)) {
						for (i = 0;i<9;i++) {
							if (i!=c && i!=sub) {
								for (j = 1;j<10;j++) {
